...
(function(e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["jquery"], t)
    : ((e = e || self), (e.BootstrapTable = t(e.jQuery)));
})(this, function(t) {
  "use strict";
  ...
  function u(e, t) {
    ...
    try {
      for (
        ...
        !(a = (s = l.next()).done) && (o.push(s.value), !(t && o.length === t));
        a = !0
      );
    } catch (e) {
      (n = !0), (i = e);
  ...
  var S,
    ...
    C =
      o(typeof globalThis == P && globalThis) ||
      o(typeof window == P && window) ||
      o(typeof self == P && self) ||
      o(typeof T == P && T) ||
    ...
    pe = function(e) {
      return (
        "Symbol(" + ((void 0 === e ? "" : e) + ")_") + (++de + O).toString(36)
      );
    },
    ue = se("keys"),
    he = function(e) {
      ...
      se("inspectSource", function(e) {
        ...
        (e.exports = function(e, t, n, i) {
          ...
          return ("function" == typeof n &&
            ("string" == typeof t && !G(n, "name") && ne(n, "name", t),
            (o(n).source = a.join("string" == typeof t ? t : ""))),
          e === C)
            ? void (l ? (e[t] = n) : ie(t, n))
            : void (s ? !r && e[t] && (l = !0) : delete e[t],
              l ? (e[t] = n) : ne(e, t, n));
    ...
    Xe = function(e, t) {
      ...
      if (((a = c ? C : d ? C[r] || ie(r, {}) : (C[r] || {}).prototype), a))
        for (n in t) {
          if (
            ((s = t[n]),
            e.noTargetGet ? ((l = Ke(a, n)), (i = l && l.value)) : (i = a[n]),
    ...
    lt =
      ...
      function(e, t) {
        ...
        return (
          null === e
            ? (o = st())
            : ((it[nt] = ee(e)), (o = new it()), (it[nt] = null), (o[at] = e)),
          void 0 === t ? o : tt(o, t)
        );
      };
  ge[at] = !0;
  var rt = Le.f,
    ...
    St = function(e, t, o) {
      e &&
        !G((e = o ? e : e.prototype), vt) &&
        wt(e, vt, { configurable: !0, value: t });
    },
    xt = function(e) {
    ...
    Pt = function(e, t) {
      ...
      return (
        Je(e) &&
          ((o = e.constructor),
          "function" == typeof o && (o === Array || Je(o.prototype))
            ? (o = void 0)
            : U(o) && ((o = o[Tt]), null === o && (o = void 0))),
    ...
    Jt = function(e, t) {
      var o = (qt[e] = lt(Lt[Rt]));
      return (
        Nt(o, { type: Et, tag: e, description: t }), A || (o.description = t), o
      );
    },
    Zt =
      Qe && "symbol" == typeof Lt.iterator
        ? function(e) {
    ...
    eo = function(e, t, o) {
      ...
      return (
        ...
        G(qt, a)
          ? (o.enumerable
              ? (G(e, At) && e[At][a] && (e[At][a] = !1),
                (o = lt(o, { enumerable: F(0, !1) })))
              : (!G(e, At) && jt(e, At, F(1, {})), (e[At][a] = !0)),
            Qt(e, a, o))
          : jt(e, a, o)
      );
    },
    ...
    oo = function(e) {
      var t = q(e, !0),
        o = Ut.call(this, t);
      return (
        (this !== Dt || !G(qt, t) || G(zt, t)) &&
        (!(o || !G(this, t) || !G(qt, t) || (G(this, At) && this[At][t])) || o)
      );
    },
    ao = function(e, t) {
      var o = M(e),
      ...
      if (o !== Dt || !G(qt, a) || G(zt, a)) {
        var n = Ht(o, a);
        return (
          n && G(qt, a) && !(G(o, At) && o[At][a]) && (n.enumerable = !0), n
        );
      }
    },
    no = function(e) {
  ...
  Qe ||
    ...
    (Be.f = io),
    A &&
      (jt(Lt[Rt], "description", {
        configurable: !0,
        get: function() {
          return Ft(this).description;
        }
      }),
      ke(Dt, "propertyIsEnumerable", oo, { unsafe: !0 })),
    (mt.f = function(e) {
      return Jt(ft(e), e);
    })),
    Xe({ global: !0, wrap: !0, forced: !Qe, sham: !Qe }, { Symbol: Lt }),
    $t(et(Yt), function(e) {
      yt(e);
    }),
    Xe(
      { target: Et, stat: !0, forced: !Qe },
      {
        for: function(e) {
          var t = e + "";
    ...
    Xe(
      { target: "Object", stat: !0, forced: !Qe, sham: !A },
      {
        create: function(e, t) {
    ...
    Xe(
      ...
      { getOwnPropertyNames: no, getOwnPropertySymbols: io }
    ),
    Xe(
      {
        target: "Object",
  ...
  if (
    A &&
    "function" == typeof lo &&
    (!("description" in lo.prototype) || void 0 !== lo().description)
  ) {
    var ro = {},
      co = function() {
        var e =
  ...
  Xe(
    { target: "Array", proto: !0, forced: !So || !xo },
    {
      concat: function() {
        var e,
          t,
  ...
  var To = It.filter;
  Xe(
    { target: "Array", proto: !0, forced: !bo("filter") },
    {
      filter: function(e) {
  ...
  $o in [] &&
    ...
    Xe(
      { target: "Array", proto: !0, forced: Ao },
      {
        find: function(e) {
  ...
  Ro in [] &&
    ...
    Xe(
      { target: "Array", proto: !0, forced: _o },
      {
  ...
  var Fo = function(e, t) {
    ...
    Bo = Fo("indexOf");
  Xe(
    { target: "Array", proto: !0, forced: Vo || Bo },
    {
      indexOf: function(e) {
        return Vo
          ? Lo.apply(this, arguments) || 0
          : Do(this, e, 1 < arguments.length ? arguments[1] : void 0);
      }
    }
  );
  var Ho,
  ...
  [].keys &&
    ((Mo = [].keys()),
    "next" in Mo
      ? ((jo = Go(Go(Mo))), jo !== Object.prototype && (Ho = jo))
      : (Yo = !0)),
    null == Ho && (Ho = {}),
    G(Ho, Wo) ||
      ne(Ho, Wo, function() {
  ...
  var Ko = { IteratorPrototype: Ho, BUGGY_SAFARI_ITERATORS: Yo },
    ...
    Qo = function(e, t, o) {
      return (
        (e.prototype = lt(Xo, { next: F(1, o) })), St(e, t + " Iterator", !1), e
      );
    },
    Jo = function(e) {
      if (!U(e) && null !== e)
      ...
      if (
        (f &&
          ...
          ea !== Object.prototype &&
            l.next &&
            (Go(l) !== ea &&
              (Zo ? Zo(l, ea) : "function" != typeof l[oa] && ne(l, oa, sa)),
            St(l, t + " Iterator", !0))),
        n == na &&
          h &&
          h.name !== na &&
  ...
  var ua = [].join,
    ...
    ga = Fo("join", ",");
  Xe(
    { target: "Array", proto: !0, forced: ha || ga },
    {
      join: function(e) {
  ...
  var fa = ft("species"),
    ma = [].slice;
  Xe(
    { target: "Array", proto: !0, forced: !bo("slice") },
    {
      slice: function(e, t) {
        var o,
          a,
        ...
        if (
          ...
          "function" == typeof o && (o === Array || Je(o.prototype))
            ? (o = void 0)
            : U(o) && ((o = o[fa]), null === o && (o = void 0)),
          o === Array || void 0 === o)
        )
          return ma.call(s, r, c);
        for (
          a = new (void 0 === o ? Array : o)(b(c - r, 0)), i = 0;
          r < c;
          r++, i++
        )
          r in s && fo(a, i, s[r]);
  ...
  var ba = [].sort,
    ...
    Sa = Fo("sort");
  Xe(
    { target: "Array", proto: !0, forced: wa || !va || Sa },
    {
      sort: function(e) {
  ...
  Xe(
    { target: "Array", proto: !0, forced: !bo("splice") },
    {
      splice: function(e, t) {
        var o,
          a,
        ...
        if (((n.length = a), o < a)) {
          for (i = d; i < c - a; i++)
            (s = i + a), (l = i + o), s in r ? (r[l] = r[s]) : delete r[l];
  ...
  var xa = function(e, t, o) {
    ...
    Ca = function(e) {
      return function(t) {
        var o = H(t) + "";
        return (
          1 & e && (o = o.replace(Pa, "")), 2 & e && (o = o.replace(Oa, "")), o
        );
      };
    },
  ...
  var Ma = Object.assign,
    Ua =
      ...
      I(function() {
        ...
        ? function(e) {
            for (
              var t = Ze(e), o = arguments.length, a = 1, n = Be.f, i = f.f;
              o > a;
    ...
    za = function(e) {
      return function(t) {
        for (var o, a = M(t), n = et(a), s = n.length, l = 0, r = []; s > l; )
          (o = n[l++]), (!A || qa.call(a, o)) && r.push(e ? [o, a[o]] : a[o]);
        return r;
      };
    },
  ...
  var Ya = ft("toStringTag"),
    ...
    Qa = function(e) {
      ...
      return void 0 === e
        ...
        : null === e
        ? "Null"
        : "string" == typeof (o = Xa((t = Object(e)), Ya))
        ? o
        : Ka
        ? L(t)
        : "Object" == (a = L(t)) && "function" == typeof t.callee
        ? "Arguments"
        : a;
    },
    Ja = ft("toStringTag"),
    ...
    ke(
      ...
      function() {
        var e = ee(this),
          ...
          o = e.flags,
          a =
            (void 0 === o && e instanceof RegExp && !("flags" in gn)
              ? un.call(e)
              : o) + "";
        return "/" + t + "/" + a;
      },
  ...
  la(
    ...
    function() {
      ...
      return a >= o.length
        ? { value: void 0, done: !0 }
        : ((e = Tn(o, a)), (t.index += e.length), { value: e, done: !1 });
    }
  );
  var In = RegExp.prototype.exec,
    ...
    En = (function() {
      var e = /a/,
        t = /b*/g;
      return (
        In.call(e, "a"), In.call(t, "a"), 0 !== e.lastIndex || 0 !== t.lastIndex
      );
    })(),
    Rn = void 0 !== /()??/.exec("")[1];
  (En || Rn) &&
    (An = function(e) {
      var t,
        ...
        s = this;
      return (
        Rn && (o = new RegExp("^" + s.source + "$(?!\\s)", un.call(s))),
        En && (t = s.lastIndex),
        (a = In.call(s, e)),
      ...
      if (!i || !s || ("replace" === e && !Fn) || ("split" === e && !Dn)) {
        var l = /./[n],
          r = o(n, ""[e], function(e, t, o, a, n) {
            return t.exec === _n
              ? i && !n
                ? { done: !0, value: l.call(t, o, a) }
                : { done: !0, value: e.call(o, t, a) }
              : { done: !1 };
          }),
          c = r[0],
          d = r[1];
    ...
    return [
      ...
      function(e, n) {
        ...
        for (
          ...
          (h = u[0] + ""), "" == h && (l.lastIndex = Bn(r, Ie(l.lastIndex), p));
        for (var f = "", m = 0, w = 0; w < g.length; w++) {
          u = g[w];
          for (
            var v = u[0] + "",
              S = b(y(Ce(u.index), r.length), 0),
              x = [],
              k = 1;
            k < u.length;
            k++
  ...
  Ln("search", 1, function(e, t, o) {
    return [
      ...
      function(e) {
        ...
        var l = Hn(n, i);
        return (
          qn(n.lastIndex, s) || (n.lastIndex = s), null === l ? -1 : l.index
        );
      }
    ];
  });
          ...
          "".split(/.?/).length
            ? function(e, o) {
                ...
                for (
                  ...
                  !(
                    s > d &&
                    (r.push(a.slice(d, i.index)),
                    1 < i.length &&
                      i.index < a.length &&
                      Wn.apply(r, i.slice(1)),
                    (l = i[0].length),
                    (d = s),
                    r.length >= n)
                  ));
        ...
        [
          ...
          function(n, s) {
            ...
            for (var m = 0, b = 0, w = []; b < c.length; ) {
              g.lastIndex = Kn ? b : 0;
              var v,
                S = Hn(g, Kn ? c : c.slice(b));
              if (
                null === S ||
                (v = y(Ie(g.lastIndex + (Kn ? 0 : b)), c.length)) === m
              )
                b = Bn(c, b, u);
              else {
  ...
  var ui = {
      3: {
        ...
        html: {
          ...
          searchButton:
            '<button class="btn btn-default" type="button" name="search" title="%s">%s %s</button>',
          searchClearButton:
            '<button class="btn btn-default" type="button" name="clearSearch" title="%s">%s %s</button>'
        }
      },
      4: {
        iconsPrefix: "fa",
        ...
        html: {
          ...
          searchInput: '<input class="%s%s" type="text" placeholder="%s">',
          searchButton:
            '<button class="btn btn-secondary" type="button" name="search" title="%s">%s %s</button>',
          searchClearButton:
            '<button class="btn btn-secondary" type="button" name="clearSearch" title="%s">%s %s</button>'
        }
      }
    }[di],
    hi = {
      ...
      responseHandler: function(e) {
        ...
        howMany.textContent = (e.length + " קבוצות ברשימה")
        return e;
      },
      totalField: "total",
    ...
    gi = {
      ...
      formatNoMatches: function() {
        return "עדיין לא הוספת קבוצות - לחץ על כפתור הסריקה או טען קובץ קבוצות מוכן";
      },
  ...
  Xe(
    { target: "Object", stat: !0, forced: bi },
    {
      keys: function(e) {
        return et(Ze(e));
      }
  ...
  var yi = {
      sprintf: function(e) {
        for (
          var t = arguments.length, o = Array(1 < t ? t - 1 : 0), a = 1;
          a < t;
          a++
        )
          o[a - 1] = arguments[a];
          ...
          try {
            for (
              ...
              (w.colspanIndex = S),
                1 === v
                  ? ((w.fieldIndex = S),
                    "undefined" == typeof w.field && (w.field = S))
                  : (w.colspanGroup = w.colspan);
                ...
                if (((g = h.value), 1 < g.colspanGroup)) {
                  for (
                    var m = 0,
                      ...
                      y = g.colspanIndex;
                    y < g.colspanIndex + g.colspanGroup;
                    y++
                  )
                    b(y);
      ...
      calculateObjectValue: function(e, t, o, n) {
        ...
        return null !== i && "object" === a(i)
          ? i
          : "function" == typeof i
          ? i.apply(e, o || [])
          : !i &&
            "string" == typeof t &&
            this.sprintf.apply(this, [t].concat(r(o)))
          ? this.sprintf.apply(this, [t].concat(r(o)))
          : n;
      },
      ...
      findIndex: function(e, t) {
        ...
        try {
          for (
            ...
            if (((s = i.value), JSON.stringify(s) === JSON.stringify(t)))
              return e.indexOf(s);
        } catch (e) {
          (a = !0), (n = e);
        } finally {
          ...
          o.each(function(o, s) {
            ...
            (l._id = t(s).attr("id")),
              ...
              t(s)
                ...
                .each(function(n, s) {
                  for (
                    var r = +t(s).attr("colspan") || 1,
                      c = +t(s).attr("rowspan") || 1,
                      d = n;
                    i[o] && i[o][d];
                    d++
                  );
                  ...
                  (l[h] = t(s)
                    ...
                    (l["_".concat(h, "_data")] = a.getRealDataAttr(
                      t(s).data()
                    ));
                }),
              n.push(l);
      ...
      sort: function(e, t, o, n) {
        ...
        (void 0 === t || null === t) && (t = ""),
        n && e === t && ((e = e._position), (t = t._position)),
    ...
    Si = (function() {
      function e(t) {
        ...
        n(this, e),
          ...
          (this.lastCluster = 0);
        var a = function() {
          o.lastCluster !== (o.lastCluster = o.getNum()) &&
        ...
        s(e, [
          {
            ...
            value: function(e) {
              ...
              var t = this.initData(e, this.getNum()),
                ...
                s = [];
              a && n
                ? (t.topOffset && s.push(this.getExtra("top", t.topOffset)),
                  s.push(o),
                  t.bottomOffset &&
                    s.push(this.getExtra("bottom", t.bottomOffset)),
          ...
          },
          {
            ...
            value: function(e, t) {
              if (e.length < wi)
                return { topOffset: 0, bottomOffset: 0, rowsAbove: 0, rows: e };
          ...
          },
          {
            ...
            value: function(e, t) {
              ...
              return (
                (o.className = "virtual-scroll-".concat(e)),
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function() {
              ...
              this.constants.buttonsClass = [
                e.buttonsPrefix,
                o + e.buttonsClass,
                yi.sprintf("".concat(o, "%s"), e.iconSize)
              ]
                .join(" ")
                .trim();
            }
              ...
              if (this.options.locale) {
                ...
                (o[0] = o[0].toLowerCase()),
                  ...
                  e[this.options.locale]
                    ...
                    : e[o.join("-")]
                    ? t.extend(this.options, e[o.join("-")])
                    : e[o[0]] && t.extend(this.options, e[o[0]]);
              }
            }
          },
          {
            ...
            value: function() {
              ...
              (this.$container = t(
                ...
                (this.$toolbar = this.options.buttonsToolbar
                  ? t("body").find(this.options.buttonsToolbar)
              ...
              (this.$header = this.$el.find(">thead")),
                ...
                this.$header.find("tr").each(function(e, o) {
                  ...
                  t(o)
                    .find("th")
                    .each(function(e, o) {
                      "undefined" != typeof t(o).data("field") &&
                        t(o).data("field", "".concat(t(o).data("field"))),
                        n.push(
                          t.extend(
                            {},
                            {
                              ...
                              rowspan: t(o).attr("rowspan")
                                ? +t(o).attr("rowspan")
                                : void 0,
                              colspan: t(o).attr("colspan")
                                ? +t(o).attr("colspan")
                                : void 0
                            },
                            t(o).data()
              ...
              (this.header = {
                ...
                this.options.columns.forEach(function(e, t) {
                  n.push("<tr>"),
                    0 === t &&
                      !o.options.cardView &&
                      o.options.detailView &&
                      o.options.detailViewIcon &&
                      n.push(
                        ...
                        n.push(
                          ...
                          n.push(
                            yi.sprintf(
                              ...
                              o.options.sortable && e.sortable
                                ? "sortable both"
                                : ""
                            )
                          );
                        var u = o.options.escape
                            ? yi.escapeHTML(e.title)
                            : e.title,
                          h = u;
                        e.checkbox &&
                          ((u = ""),
                          !o.options.singleSelect &&
                ...
                this.$container
                  .off("click", ".th-inner")
                  .on("click", ".th-inner", function(a) {
                    var e = t(a.currentTarget);
                    return (
                      (!o.options.detailView ||
                        e.parent().hasClass("bs-checkbox") ||
                        e.closest(".bootstrap-table")[0] === o.$container[0]) &&
                      void (
                        o.options.sortable &&
                        e.parent().data().sortable &&
                        o.onSort(a)
                      )
                    );
                  }),
                this.$header
                  ...
                  .on("keypress", function(a) {
                    if (
                      o.options.sortable &&
                      t(a.currentTarget).data().sortable
                    ) {
                      var e = a.keyCode || a.which;
                      13 === e && o.onSort(a);
                    }
                  });
              var i = "resize.bootstrap-table".concat(
                this.$el.attr("id") || ""
              );
              t(window).off(i),
              ...
              -1 !== n &&
                ...
                this.options.customSort
                  ...
                  : this.data.sort(function(i, a) {
                      ...
                      return void 0 === r
                        ? yi.sort(s, l, o, e.options.sortStable)
                        : e.options.sortStable && 0 === r
                        ? o * (i._position - a._position)
                        : o * r;
                    }),
                void 0 !== this.options.sortClass &&
                  ...
                  (i = setTimeout(function() {
                    ...
                    var t = e.$header
                      .find('[data-field="'.concat(e.options.sortName, '"]'))
                      .index();
                    e.$el
                      .find("tr td:nth-child(".concat(t + 1, ")"))
                      .addClass(e.options.sortClass);
                  }, 250))));
            }
          },
          {
            ...
            value: function(e) {
              ...
              return (
                this.$header
                  ...
                  .find("span.order")
                  .remove(),
                this.options.sortName === n.data("field")
                  ...
                  : ((this.options.sortName = n.data("field")),
                    (this.options.sortOrder = this.options.rememberOrder
                      ? "asc" === n.data("order")
                        ? "desc"
                        : "asc"
                      : this.columns[this.fieldsColumnsIndex[n.data("field")]]
                          .sortOrder ||
                        this.columns[this.fieldsColumnsIndex[n.data("field")]]
                          .order)),
                this.trigger(
            ...
            value: function() {
              ...
              if (
                (this.$toolbar.find(".bs-bars").children().length &&
                  t("body").append(t(l.toolbar)),
                this.$toolbar.html(""),
                ("string" == typeof l.toolbar || "object" === a(l.toolbar)) &&
                  t(
                    yi.sprintf(
                ...
                (o = [
                  '<div class="'.concat(
                    [
                      "columns",
                      "columns-".concat(l.buttonsAlign),
                      this.constants.classes.buttonsGroup,
                      ""
                        .concat(this.constants.classes.pull, "-")
                        .concat(l.buttonsAlign)
                    ].join(" "),
                    '">'
                  )
                ]),
                "string" == typeof l.icons &&
                  (l.icons = yi.calculateObjectValue(null, l.icons)),
                l.showPaginationSwitch &&
                  o.push(
                    '<button class="'
                      .concat(
                        this.constants.buttonsClass,
                      ...
                      .concat(l.formatPaginationSwitch(), '">\n        ')
                      .concat(
                        l.showButtonIcons
                          ? yi.sprintf(
                              this.constants.html.icon,
                              l.iconsPrefix,
                              l.icons.paginationSwitchDown
                            )
                          : "",
                        "\n        "
                      )
                ...
                l.showToggle &&
                  o.push(
                    '<button class="'
                      ...
                      .concat(
                        l.showButtonText ? l.formatToggleOn() : "",
                        "\n        </button>"
                      )
                  ),
                l.showFullscreen &&
                ...
                if (
                  ...
                  var c =
                    this.getVisibleColumns().length === this.columns.length;
                  o.push(
                    yi.sprintf(
                ...
                this.columns.forEach(function(e, t) {
                  if (
                    !(e.radio || e.checkbox) &&
                    (!l.cardView || e.cardVisible)
                  ) {
                    var a = e.visible ? ' checked="checked"' : "";
                    e.switchable &&
                      (o.push(
                        yi.sprintf(
                          s.constants.html.toolbarDropdownItem,
                          yi.sprintf(
                ...
                r <= l.minimumCountColumns &&
                  ...
                  d.off("click").on("click", function(e) {
                    ...
                    s._toggleColumn(a.val(), a.prop("checked"), !1),
                      ...
                      p.prop(
                        "checked",
                        d.filter(":checked").length === s.columns.length
                      );
                  }),
              ...
              if (l.search) {
                ...
                var u = yi.sprintf(
                  ...
                  g = '<input class="'
                    ...
                    .concat(l.formatSearch(), '">'),
                  f = g;
                (l.showSearchButton || l.showSearchClearButton) &&
                  (f = yi.sprintf(
                    this.constants.html.inputGroup,
                    g,
                    (l.showSearchButton ? u : "") +
                      (l.showSearchClearButton ? h : "")
                  )),
                  o.push(
                    yi.sprintf(
                      '\n        <div class="'
                        .concat(this.constants.classes.pull, "-")
                        .concat(l.searchAlign, " search ")
                        .concat(
                ...
                n = l.showSearchButton
                  ? this.$toolbar.find(".search button[name=search]")
                  : m;
                var b = l.showSearchButton
                  ? "click"
                  : yi.isIEBrowser()
                  ? "mouseup"
                  : "keyup drop blur";
                n.off(b).on(b, function(e) {
                  (l.searchOnEnterKey && 13 !== e.keyCode) ||
            ...
            value: function() {
              ...
              if (void 0 !== o && n) {
                var i = t(o)
                  ...
                  .trim();
                if (
                  (this.options.trimOnSearch && t(o).val() !== i && t(o).val(i),
                  this.searchText === i)
                )
                  return;
          ...
          },
          {
            ...
            value: function() {
              ...
              if (
                ...
                this.data = t
                  ? this.data.filter(function(o, n) {
                      for (var i = 0; i < e.header.fields.length; i++)
                        if (
                          e.header.searchables[i] &&
                          (!e.options.visibleSearch ||
                            -1 !== a.indexOf(e.header.fields[i]))
                        ) {
                          var s = yi.isNumeric(e.header.fields[i])
                              ? parseInt(e.header.fields[i], 10)
                              : e.header.fields[i],
          ...
          },
          {
            ...
            value: function() {
              ...
              var o,
                ...
                g = a.pageList;
              if (
                ("server" !== a.sidePagination && (a.totalRows = h.length),
                (this.totalPages = 0),
                a.totalRows)
              ) {
              ...
              var m = a.onlyInfoPagination
                ? a.formatDetailPagination(a.totalRows)
                : a.formatShowingRows(
                    this.pageFrom,
                    this.pageTo,
                    a.totalRows,
              ...
              if (
                      ...
                      (k = x.value),
                        g.push(
                          k.toLowerCase() === a.formatAllRows().toLowerCase() ||
                            ["all", "unlimited"].includes(k.toLowerCase())
                            ? a.formatAllRows()
                            : +k
                        );
                  } catch (e) {
                ...
                g.forEach(function(e, o) {
                  ...
                  p.push(
                    '<div class="'
                      .concat(this.constants.classes.pull, "-")
                      .concat(a.paginationHAlign, ' pagination">'),
                    yi.sprintf(
                  ...
                  this.totalPages < a.paginationSuccessivelySize
                    ? ((n = 1), (s = this.totalPages))
                    : ((n = a.pageNumber - a.paginationPagesBySide),
                      (s = n + 2 * a.paginationPagesBySide)),
                  a.pageNumber < a.paginationSuccessivelySize - 1 &&
                    (s = a.paginationSuccessivelySize),
                  a.paginationSuccessivelySize > this.totalPages - n &&
                    (n =
                      n -
                      (a.paginationSuccessivelySize - (this.totalPages - n)) +
                      1),
                    ...
                    return yi.sprintf(
                      ...
                      o +
                        (e === a.pageNumber
                          ...
                          : ""),
                      a.formatSRPaginationPageText(e),
                      e
                    );
                  };
                if (1 < n) {
                  ...
                  n - 1 === C + 1
                    ? ((o = n - 1), p.push(O(o)))
                    : n - 1 > C &&
                      (n - 2 * a.paginationPagesBySide >
                        a.paginationPagesBySide && a.paginationUseIntermediate
                        ? ((o = e((n - P) / 2 + P)),
                          p.push(O(o, " page-intermediate")))
                        : p.push(
                            yi.sprintf(
                              this.constants.html.paginationItem,
                  ...
                  for (
                    s >= I && (I = s + 1),
                      s + 1 === I - 1
                        ? ((o = s + 1), p.push(O(o)))
                        : I > s + 1 &&
                          (this.totalPages - s > 2 * a.paginationPagesBySide &&
                          a.paginationUseIntermediate
                            ? ((o = e((this.totalPages - P - s) / 2 + s)),
                              p.push(O(o, " page-intermediate")))
                            : p.push(
                                yi.sprintf(
                                  this.constants.html.paginationItem,
                ...
                p.push(
                  yi.sprintf(
                    this.constants.html.paginationItem,
                    " page-next",
                    a.formatSRPaginationNextText(),
                    a.paginationNextText
                  )
                ),
                  p.push(this.constants.html.pagination[1], "</div>");
              }
              this.$pagination.html(p.join(""));
              var $ = ["bottom", "both"].includes(a.paginationVAlign)
              ...
              this.$pagination
                ...
                .addClass($),
                a.onlyInfoPagination ||
                  ((l = this.$pagination.find(".page-list a")),
                  ...
                  a.smartDisplay &&
                    (2 > g.length || a.totalRows <= g[0]) &&
                    this.$pagination.find("span.page-list").hide(),
                  this.$pagination[this.getData().length ? "show" : "hide"](),
                  !a.paginationLoop &&
                    (1 === a.pageNumber && r.addClass("disabled"),
            ...
            value: function(e, t) {
              ...
              if (!(-1 < yi.findIndex(this.hiddenRows, e))) {
                if (
                  ...
                  for (
                    var p = 0, u = Object.entries(i.css);
                    p < u.length;
                    p++
                  ) {
                    var h = l(u[p], 2),
                ...
                if (e._data && !yi.isEmptyObject(e._data))
                  for (
                    var w = 0, S = Object.entries(e._data);
                    w < S.length;
                    w++
                  ) {
                    var x = l(S[w], 2),
                    ...
                    r += " data-"
                      .concat(T, "='")
                      .concat("object" === a(k) ? JSON.stringify(k) : k, "'");
                  }
                return (
                  n.push(
                    "<tr",
                  ...
                  this.header.fields.forEach(function(a, i) {
                    ...
                    if (
                      (!o.fromHtml ||
                        ...
                        x.radio) &&
                      x.visible &&
                      (!o.options.cardView || x.cardVisible)
                    ) {
                      if (
                        (x.escape && (d = yi.escapeHTML(d)),
                        s.concat([o.header.styles[i]]).length &&
                          (m = ' style="'.concat(
                            s.concat([o.header.styles[i]]).join("; "),
                            '"'
                          )),
                        e["_".concat(a, "_id")] &&
                          (g = yi.sprintf(' id="%s"', e["_".concat(a, "_id")])),
                        e["_".concat(a, "_class")] &&
                          (f = yi.sprintf(
                            ' class="%s"',
                            e["_".concat(a, "_class")]
                          )),
                        e["_".concat(a, "_rowspan")] &&
                          (y = yi.sprintf(
                            ' rowspan="%s"',
                            e["_".concat(a, "_rowspan")]
                          )),
                        e["_".concat(a, "_colspan")] &&
                          (w = yi.sprintf(
                            ' colspan="%s"',
                            e["_".concat(a, "_colspan")]
                          )),
                        ...
                        (h = yi.calculateObjectValue(
                          o.header,
                          o.header.cellStyles[i],
                          [d, e, t, a],
                          h
                        )),
                        ...
                        for (
                          var T = [], P = 0, O = Object.entries(h.css);
                          P < O.length;
                          P++
                        ) {
                          var C = l(O[P], 2),
                        ...
                        m = ' style="'.concat(
                          T.concat(o.header.styles[i]).join("; "),
                          '"'
                        );
                      }
                      if (
                        ((p = yi.calculateObjectValue(
                          x,
                          o.header.formatters[i],
                          [d, e, t, a],
                          d
                        )),
                        e["_".concat(a, "_data")] &&
                        ...
                        for (
                          var A = 0,
                            E = Object.entries(e["_".concat(a, "_data")]);
                          A < E.length;
                          A++
                        ) {
                          var R = l(E[A], 2),
                      ...
                      if (x.checkbox || x.radio) {
                        ...
                        (r = [
                          ...
                          o.header.formatters[i] && "string" == typeof p
                            ? p
                            : "",
                        ...
                        var F = o.options.showHeader
                          ? '<span class="card-view-title"'
                              .concat(m, ">")
                              .concat(yi.getFieldTitle(o.columns, a), "</span>")
                          : "";
                        (r = '<div class="card-view">'
                          .concat(F, '<span class="card-view-value">')
                          .concat(p, "</span></div>")),
            ...
            value: function(e) {
              ...
              for (
                ...
                (l = l || !!d),
                  d &&
                    "string" == typeof d &&
                    (this.options.virtualScroll ? n.push(d) : s.append(d));
              }
              l
                ...
                this.$body
                  ...
                  .on("click dblclick", function(a) {
                    ...
                    if (!e.find(".detail-icon").length) {
                      if (
                        (o.trigger(
                          "click" === a.type ? "click-cell" : "dbl-click-cell",
                          p,
                          h,
                          r,
                          e
                        ...
                        o.trigger(
                          "click" === a.type ? "click-row" : "dbl-click-row",
                          r,
                          n,
                          p
                        ),
                        "click" === a.type &&
                          o.options.clickToSelect &&
                          u.clickToSelect &&
                          !yi.calculateObjectValue(
                            o.options,
                            o.options.ignoreClickToSelectOn,
                            [a.target]
                          ))
                      ) {
                        var g = n.find(
                ...
                (this.$selectItem = this.$body.find(
                  yi.sprintf('[name="%s"]', this.options.selectItemName)
                )),
                ...
                this.header.events.forEach(function(e, a) {
                  ...
                  if (n) {
                    "string" == typeof n &&
                      (n = yi.calculateObjectValue(null, n));
                      ...
                      var l = function(e) {
                        ...
                        o.$body
                          ...
                          .each(function(n, l) {
                            var r = t(l),
                              c = r
                                .find(o.options.cardView ? ".card-view" : "td")
                                .eq(s),
                              d = e.indexOf(" "),
                              p = e.substring(0, d),
                              u = e.substring(d + 1);
                ...
                this.resetView(),
                "server" !== this.options.sidePagination &&
                  (this.options.totalRows = a.length),
            ...
            value: function(e, o, a) {
              ...
              if (
                (this.header.sortNames[s] &&
                  (l.sortName = this.header.sortNames[s]),
                this.options.pagination &&
                  "server" === this.options.sidePagination &&
                  ((l.pageSize =
                ...
                a || this.options.url || this.options.ajax) &&
                ...
                yi.isEmptyObject(this.filterColumnsPartial) ||
            ...
            value: function() {
              ...
              this.$header.find("th").each(function(o, a) {
                t(a)
                  ...
                  .addClass(
                    t(a).data("field") === e.options.sortName
                      ? e.options.sortOrder
                      : "both"
                  );
              });
            ...
            value: function() {
              ...
              this.$selectAll.add(this.$selectAll_).prop("checked", e),
                this.$selectItem.each(function(e, o) {
                  t(o)
                    .closest("tr")
                    [t(o).prop("checked") ? "addClass" : "removeClass"](
                      "selected"
                    );
                });
            }
          },
          {
            ...
            value: function() {
              ...
              this.$selectItem.each(function(o, a) {
                e.data[t(a).data("index")][e.header.stateField] = t(a).prop(
                  "checked"
                );
              });
            }
          },
          {
            ...
            value: function() {
              ...
              try {
                for (
                  var a, n, i = this.data[Symbol.iterator]();
                  !(e = (a = i.next()).done);
                  e = !0
                )
                  (n = a.value),
            ...
            value: function() {
              ...
              var o = this.$tableBody.get(0),
                a =
                  ...
                  o.scrollHeight > o.clientHeight + this.$header.outerHeight()
                    ? yi.getScrollBarWidth()
                    : 0;
              ...
              0 < r.length &&
                ...
                this.$header.find("th[data-field]").each(function(o, a) {
                  e.$header_
                    .find(yi.sprintf('th[data-field="%s"]', t(a).data("field")))
                    .data(t(a).data());
                });
              for (
                var c = this.getVisibleFields(),
                  ...
                  p = this.$body
                    ...
                    .eq(0);
                p.length && p.find('>td[colspan]:not([colspan="1"])').length;
              ...
              p.find("> *").each(function(o, a) {
                ...
                if (-1 !== i) {
                  var r = e.$header_.find(
                    yi.sprintf('th[data-field="%s"]', c[i])
                  );
          ...
          },
          {
            ...
            value: function() {
              if (this.options.showFooter && !this.options.cardView) {
                ...
                try {
                  for (
                    var i, s = this.columns[Symbol.iterator]();
                    !(o = (i = s.next()).done);
                    o = !0
                  ) {
                    var r = i.value,
                    ...
                    if (r.visible) {
                      ...
                      if (
                        ...
                        for (
                          var g = 0, f = Object.entries(u.css);
                          g < f.length;
                          g++
                        ) {
                          var m = l(f[g], 2),
            ...
            value: function() {
              ...
              for (
                var n = this.getVisibleFields(),
                  s = this.$tableFooter.find("th"),
                  l = this.$body.find(">tr:first-child:not(.no-records-found)");
                l.length && l.find('>td[colspan]:not([colspan="1"])').length;
              ...
              this.trigger("scroll-body"),
                this.$tableBody.off("scroll").on("scroll", function(o) {
                  ...
                  e.options.showHeader &&
                    e.options.height &&
                    e.$tableHeader.scrollLeft(t(a).scrollLeft()),
                    e.options.showFooter &&
                      !e.options.cardView &&
                      e.$tableFooter.scrollLeft(t(a).scrollLeft());
                });
            }
          },
          {
            ...
            value: function() {
              ...
              try {
                for (
                  var n, i = this.header.fields[Symbol.iterator]();
                  !(t = (n = i.next()).done);
                  t = !0
                ) {
                  var s = n.value,
          ...
          },
          {
            key: "refreshOptions",
            value: function(e) {
              yi.compareObjects(this.options, e, !0) ||
          ...
          },
          {
            ...
            value: function(e) {
              ...
              if (
                ...
                e &&
                  e.useCurrentPage &&
                  (t = t.slice(this.pageFrom - 1, this.pageTo)),
              ...
              this.options.pagination &&
                ...
                this.options.pagination &&
                  ...
                  (this.options.totalNotFiltered =
                    o[this.options.totalNotFilteredField]),
                (t = o.fixedScroll),
              ...
              if (e.hasOwnProperty("field") && e.hasOwnProperty("values")) {
                for (t = a - 1; 0 <= t; t--)
                  ((o = this.options.data[t]), !!o.hasOwnProperty(e.field)) &&
                    e.values.includes(o[e.field]) &&
                    (this.options.data.splice(t, 1),
                    "server" === this.options.sidePagination &&
          ...
          },
          {
            ...
            value: function(e) {
              ...
              try {
                for (
                  var s, l, r = o[Symbol.iterator]();
                  !(a = (s = r.next()).done);
                  a = !0
                )
                  ((l = s.value),
                  l.hasOwnProperty("index") && l.hasOwnProperty("row")) &&
            ...
            value: function(e, t) {
              ...
              if (
                (e.hasOwnProperty("index")
                  ...
                  : e.hasOwnProperty("uniqueId") &&
                    (o = this.getRowByUniqueId(e.uniqueId)),
                !!o)
              ) {
                var a = yi.findIndex(this.hiddenRows, o);
                t || -1 !== a
                  ? t && -1 < a && this.hiddenRows.splice(a, 1)
          ...
          },
          {
            ...
            value: function(e) {
              ...
              return e
                ? void this.trigger("check-all", o, t)
                : void this.trigger("uncheck-all", o, t);
            }
          },
          {
            key: "checkInvert",
          ...
          },
          {
            ...
            value: function(e, t) {
              ...
              if (
                ...
                try {
                  for (
                    var c, d, p = this.options.data[Symbol.iterator]();
                    !(n = (c = p.next()).done);
                    n = !0
                  )
              ...
              if (
                ...
                if (
                  this.multipleSelectRowShiftKey &&
                  0 <= this.multipleSelectRowLastSelectedIndex
                )
                  for (
                    var u = [this.multipleSelectRowLastSelectedIndex, t].sort(),
                      h = u[0] + 1;
                    h < u[1];
                    h++
                  )
              ...
              if (t.hasOwnProperty("field") && t.hasOwnProperty("values")) {
                ...
                this.data.forEach(function(n, s) {
                  ...
                  if (t.values.includes(n[t.field])) {
                    var i = o.$selectItem
                      .filter(":enabled")
                      .filter(yi.sprintf('[data-index="%s"]', s))
                      .prop("checked", e);
            ...
            value: function(e) {
              ...
              if (
                ...
                !this.options.cardView &&
                  ...
                  this.fitFooter(),
                  this.options.height &&
                    (t += this.$tableFooter.outerHeight(!0))),
                this.options.height)
              ) {
          ...
          },
          {
            key: "filterBy",
            value: function(e, o) {
              (this.filterOptions = yi.isEmptyObject(o)
                ? this.options.filterOptions
                : t.extend(this.options.filterOptions, o)),
              ...
              if (
                ...
                o.find("th[data-field]").each(function(o, a) {
                  if (t(a).data("field") === e.field)
                    return t(t(a).find(".th-inner")[0]).text(e.title), !1;
                });
              }
            }
          },
  ...
  return (
    ...
    (t.fn.bootstrapTable = function(e) {
      for (
        var o = arguments.length, n = Array(1 < o ? o - 1 : 0), i = 1;
        i < o;
        i++
      )
        n[i - 1] = arguments[i];
